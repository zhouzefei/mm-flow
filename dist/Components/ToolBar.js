  ...
  _createClass(ToolBar, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_row.default, _extends({
        className: "flow-toolbar ".concat(className || "")
      }, style), _react.default.Children.map(children, function (child, index) {
        var propsData = {
          index: index
        };
        ...
        return _react.default.cloneElement(child, _objectSpread({}, propsData));
      }));
    }
  }]);
